...
<h1 class="title1">Hollywood Movies</h2>
<div class="wrapper">
<div class="col-md-4">
    <img src="images/22.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="single.php">Replicas (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/23.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">After (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/7.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">The Spongebob (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/28.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Black Panther (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/9.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">In Time (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/29.jpeg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Nightingale (2018) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/51.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">A Star Is Born (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/2.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">The Protector 2 (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/21.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Alladin (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/25.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">MoonLight (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/27.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Dora And The Lost City Of Gold (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/26.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Us (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/16.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Of Mice And Men (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/19.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Hate Story (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/24.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Haunted (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
