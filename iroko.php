...
<div class="left col-sm-9"> <!--Opening left div-->

<h1 class="title1">Nollywood/Iroko Movies</h2>
<div class="wrapper">
<div class="col-md-4">
    <img src="images/52.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Muna (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/53.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Guy Next Door (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/54.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">The Grudge (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/55.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Last Flight To Abuja (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/56.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">War In France (2019) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/57.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">From Lagos With Love (2018) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/58.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Living In Bondage (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/59.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Gold Statue (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/60.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Mr President (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/33.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Stalker (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/34.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Journey to Self (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/40.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">The Department (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/41.jfif" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Amina (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/42.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Sylvia (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <img src="images/43.jpg" style="height: 250px; width: 250px; object-fit: cover;">
    <p class="text1"> <a href="#">Phone Swap (2020) <i class="fa fa-download"></i></a> </p>
</div>
<div class="col-md-4">
    <a href="#">prev <i class="fa fa-angle-left"></i></a>
</div>
<div class="col-md-4">
